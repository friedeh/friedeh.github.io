...
knitr::include_graphics("images/PubMed_Logo.png")
```

```{r fig.cap="Zugriff auf das Internet: Wandlung von stationären zu mobilen Devices"}
knitr::include_graphics("images/PubMed_Website.png")
```

```{r fig.cap="Zugriff auf das Internet: Wandlung von stationären zu mobilen Devices"}
knitr::include_graphics("images/PubMed_mobile.jpg")
```
...
```{r fig.cap="Zugriff auf das Internet: Wandlung von stationären zu mobilen Devices", layout="l-page"}
knitr::include_graphics("images/iPod_bis_iPad.png")
```
...
knitr::include_graphics("images/Daten_Normseite.png")
```

```{r fig.cap="Entwicklung der Datenmenge im Internet"}
knitr::include_graphics("images/Daten_Menschliches_Genom.png")
```
...
knitr::include_graphics("images/BIG_Data_5Vs.png")
```
...
knitr::include_graphics("images/Chat_Beispiel.png")
```
